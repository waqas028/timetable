...
public class Database {
    ...
    public static java.lang.Class cursorToClass(Cursor classes) {
		java.lang.Class cls = new java.lang.Class();
	...
	public static ArrayList<java.lang.Class> getClasses(Context context, String batchcode) {
		DBHelper dbhelper = new DBHelper(context);
		SQLiteDatabase db = dbhelper.getReadableDatabase();
		...
		while (classes.moveToNext()) {
			java.lang.Class cls = Database.cursorToClass(classes);
			list.add(cls);
		}
		classes.close();
		db.close();
	...
	public static java.lang.Class getClass(Context context, String classid) {
		DBHelper dbhelper = new DBHelper(context);
		SQLiteDatabase db = dbhelper.getReadableDatabase();
		Cursor classes = db.query(Database.CLASSES_TABLE_NAME, null,
